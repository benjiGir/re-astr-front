const DefaultProfilePictureIcon = () => (
  <svg fill="#000000" height="100%" width="100%" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
export default DefaultProfilePictureIcon;
